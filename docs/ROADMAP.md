...
## Phase 4 — sharing with others

- [ ] Named spaces with signed member lists and roles (owner/writer/reader).
...
**Exit criterion**: a teammate's session reads a `team-*` space entry you authored, and cannot read your `personal` space.
